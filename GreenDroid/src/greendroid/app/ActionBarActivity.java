...
/**
 * Defines all methods related to Activities embedding an {@linGDActionBarnBar}
 * 
...
public interface ActionBarActivity {
    ...
    /**
     * Returns theGDActionBarDActionBar}. Listening GDActionBar GDActionBar} events
     * should be done via the
     * {@link ActionBarActivity#onHandleActionBarItemClick(GDActionBarItem, int)}
     * method. Most of the time, this method don't need to be used directly.
     * 
     * @see {@link ActionBarActivity#onHandleActionBarItemClick(GDActionBarItem, int)}
     * @see {@link ActionBarActivity#addActionBarItem(GDActionBarItem)}
     * @see {@link ActionBarActivity#addActionBarItem(greendroid.widget.GDActionBarItem.Type)}
     * @returnGDActionBarnk GDActionBar} currently displayed on screenGDActionBar
    ...
    /**
     * Add a new iteGDActionBar{@link GDActionBar}.
     * 
     * @param item The item to GDActionBare {@link GDActionBar}
     */
    GDActionBarItem addActionBarItem(GDActionBarItem item);

    /**
     * Add a newGDActionBarthe {@link GDActionBar}.
     * 
     * @param item The itemGDActionBaro the {@link GDActionBar}
     * @param itemId UniGDActionBarID. Use {@link GDActionBar#NONE} if you do not
     *            need a unique ID.
     */
    GDActionBarItem addActionBarItem(GDActionBarItem item, int itemId);

    /**
     * Adds a new item of type <eGDActionBarm> to the {@link GDActionBar}.
     * 
     * @param actionBarItemType ThGDActionBar add to the {@link GDActionBar}
     */
    GDActionBarItem addActionBarItem(GDActionBarItem.Type actionBarItemType);

    /**
     * Adds a new item of typGDActionBare</em> to the {@link GDActionBar}.
     * 
     * @param actionBarItemTypGDActionBarm to add to the {@link GDActionBar}
     * @param GDActionBarique item ID. Use {@link GDActionBar#NONE} if you do not
     *            need a unique ID.
     */
